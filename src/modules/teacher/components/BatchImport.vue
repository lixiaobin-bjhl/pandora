<template>
      <el-dialog 
        ...
        :visible.sync="$store.state.teacher.showImportTeacherState"
        >
        <div class="body">
            ...
            <ul class="upload-notice" v-if="step == 1">
                <li>
                    <h2><span>1</span>请下载教师导入模板<a class="clickable-text clickable-text-blue" download="导入模板" href="http://omh2h1x76.bkt.clouddn.com/%E8%B4%A6%E5%8F%B7%E5%AF%BC%E5%85%A5%E6%A8%A1%E6%9D%BF.xlsx">下载模板</a></h2>
    ...
    export default   {
        ...
        methods: {
            ...
            upload () {
                ...
                $.ajax({
					url: '/utraining/common/importTeacher.do',
	                type: 'POST',
	                contentType: false,
	                data: fd,
	                dataType: 'json',
             ...
             */
            cancelUpload () {
                this.$store.commit('HIDE_IMPORT_TEACHER');
            },
